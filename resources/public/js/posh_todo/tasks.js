...
return (function posh_todo$tasks$task_panel_$_iter__21150(s__21151){
return (new cljs.core.LazySeq(null,((function (c,cat_name,tasks){
return (function (){
var s__21151__$1 = s__21151;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__21151__$1);
if(temp__4425__auto__){
var s__21151__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__21151__$2)){
var c__17502__auto__ = cljs.core.chunk_first.call(null,s__21151__$2);
var size__17503__auto__ = cljs.core.count.call(null,c__17502__auto__);
var b__21153 = cljs.core.chunk_buffer.call(null,size__17503__auto__);
if((function (){var i__21152 = (0);
while(true){
if((i__21152 < size__17503__auto__)){
var t = cljs.core._nth.call(null,c__17502__auto__,i__21152);
cljs.core.chunk_append.call(null,b__21153,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [posh_todo.tasks.task,conn,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(t)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(t)], null)));

var G__21154 = (i__21152 + (1));
i__21152 = G__21154;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21153),posh_todo$tasks$task_panel_$_iter__21150.call(null,cljs.core.chunk_rest.call(null,s__21151__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21153),null);
}
} else {
var t = cljs.core.first.call(null,s__21151__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [posh_todo.tasks.task,conn,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(t)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(t)], null)),posh_todo$tasks$task_panel_$_iter__21150.call(null,cljs.core.rest.call(null,s__21151__$2)));
}
} else {
return null;
}
